...
import ar.com.wolox.android.example.MotionLayout
...
interface AppComponent : AndroidInjector<MotionLayout> {

    @Component.Builder
    abstract class Builder : AndroidInjector.Builder<MotionLayout>() {
